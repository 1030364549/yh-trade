<div class="bjui-pageHeader">
 <form id="pagerForm" data-toggle="ajaxsearch" action="${urls}" method="post">
  <div class="bjui-searchBar">
      ...
      <p>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>部门: </span>&nbsp;&nbsp;
          <select name="department" id="province1" data-toggle="selectpicker"  selectvl="${(p.params.department)!}"   data-nextselect="#j_form_department12" data-refurl="/yhtrade/Salesman/getCompanydept?comp_id={value}">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;<span>大区: </span>&nbsp;&nbsp;
          <select name="argeaarea" id="j_form_department12" data-toggle="selectpicker"   selectvl="${(p.params.argeaarea)!''}"   data-nextselect="#j_form_largearea12" data-refurl="/yhtrade/Salesman/getCompanydept?comp_id={value}" data-emptytxt="请选择">
              <option value="">请选择</option>
              <#if ARGEAAREA ??>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;<span>分公司: </span>&nbsp;&nbsp;
          <select name="branchoffice" id="j_form_largearea12" data-toggle="selectpicker"  selectvl="${(p.params.branchoffice)!''}"  data-nextselect="#j_form_branchoffice12"  data-refurl="/yhtrade/Salesman/getCompanydept?comp_id={value}" data-emptytxt="请选择">
              <option value="">请选择</option>
              <#if BRANCHOFFICE ??>
      ...
      <p>
          &nbsp;&nbsp;&nbsp;<span>添加时间(起始)：</span>
          <input type="text" name="startlocaldate" value="${(p.params.startlocaldate)!''}" readonly data-toggle="datepicker" class="form-control" size="11"> &nbsp;
          <span>添加时间(截止)：</span>
          <input type="text" name="endlocaldate" value="${(p.params.endlocaldate)!''}" readonly data-toggle="datepicker" class="form-control" size="11"> &nbsp;
          <span>有效期(起始)：</span>
          <input type="text" name="begin_valid" value="${(p.params.begin_valid)!''}" readonly data-toggle="datepicker" class="form-control" size="11"> &nbsp;
          <span>有效期(截止)：</span>
          <input type="text" name="end_valid" value="${(p.params.end_valid)!''}" readonly data-toggle="datepicker" class="form-control" size="11"> &nbsp;
   ...
   <div style="margin-top: 1px;">
       ...
       <span><a class="btn btn-red" href="${baseClass}/agentUpdate?{#bjui-selected}&agent_status=0" data-toggle="doajax"  data-confirm-msg = "确定要将该代理商上送审核通过么？" rel="BaseinfoClass_SendExamine" width="450" ><i class="fa fa-edit"></i><span>代理商审核</span></a>&nbsp;&nbsp;</span>
  ...
  <tbody>
   <#if p.results ??>
    <#list p.results as list>
	 <tr data-id="agent_num=${(list.AGENT_NUM)!}&commissary=${(list.COMMISSARY)!}">
        ...
        <td style="color:red;">${(list.NOTE)!'<span style="color:gray">无</span>'}</td>
         <td>
             <span><a class="btn btn-blue" href="${baseClass}/adddetail?agent_num=${(list.AGENT_NUM)!}&ck=2&addtype=1" data-toggle="dialog"  rel="AgentInfo_adddetail" data-options="{id:'dialog',title:'查看代理商',width:'920',height:'800'}"><i class="fa fa-edit"></i><span>查看详情</span></a>&nbsp;&nbsp;</span>
         </td>
        </tr>
	</#list>
   </#if>
