 ...
 <form id="pagerForm" data-toggle="ajaxsearch" action="${urls}" method="post">
  <div class="bjui-searchBar">
      ...
      <p>
          ...
          <button href="/yhtrade/Salesman/findSales" data-toggle="lookupbtn" data-title="业务员查询" data-group="sign_sale" id="haha1" data-width="1200" data-icon="search" data-title="业务员管理" class="btn-blue"></button>
          ...
          <button href="/yhtrade/Salesman/findSales" data-toggle="lookupbtn" data-title="业务员查询" data-group="maintain" id="haha" data-width="1200" data-icon="search" data-title="业务员管理" class="btn-blue"></button>
      ...
      <p>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>部门: </span>&nbsp;&nbsp;
          <select name="department" id="province1" data-toggle="selectpicker"  selectvl="${(p.params.department)!}"   data-nextselect="#j_form_department13" data-refurl="/yhtrade/Salesman/getCompanydept?comp_id={value}">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;<span>大区: </span>&nbsp;&nbsp;
          <select name="argeaarea" id="j_form_department13" data-toggle="selectpicker"   selectvl="${(p.params.argeaarea)!''}"   data-nextselect="#j_form_largearea13" data-refurl="/yhtrade/Salesman/getCompanydept?comp_id={value}" data-emptytxt="请选择">
              <option value="">请选择</option>
              <#if ARGEAAREA ??>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;<span>分公司: </span>&nbsp;&nbsp;
          <select name="branchoffice" id="j_form_largearea13" data-toggle="selectpicker"  selectvl="${(p.params.branchoffice)!''}"  data-nextselect="#j_form_branchoffice13"  data-refurl="/yhtrade/Salesman/getCompanydept?comp_id={value}" data-emptytxt="请选择">
              <option value="">请选择</option>
              <#if BRANCHOFFICE ??>
      ...
      <p>
          &nbsp;&nbsp;&nbsp;<span>添加时间(起始)：</span>
          <input type="text" name="startlocaldate" value="${(p.params.startlocaldate)!''}" data-toggle="datepicker" readonly="readonly" class="form-control" size="11"> &nbsp;
          <span>添加时间(截止)：</span>
          <input type="text" name="endlocaldate" value="${(p.params.endlocaldate)!''}" data-toggle="datepicker" readonly="readonly" class="form-control" size="11"> &nbsp;

          <span>有效期(起始)：</span>
          <input type="text" name="begin_valid" value="${(p.params.begin_valid)!''}" data-toggle="datepicker" readonly="readonly" class="form-control" size="11"> &nbsp;
          <span>有效期(截止)：</span>
          <input type="text" name="end_valid" value="${(p.params.end_valid)!''}" data-toggle="datepicker" readonly="readonly" class="form-control" size="11"> &nbsp;
...
<#--       <span><a class="btn btn-blue" href="${baseClass}/add?{#bjui-selected}&ck=1" data-toggle="dialog"  rel="BaseinfoClass_update" data-options="{id:'dialog',title:'查看代理商',width:'900',height:'800'}"><i class="fa fa-edit"></i><span>查看代理商</span></a>&nbsp;&nbsp;</span>-->
<#--	<span><a class="btn btn-blue" href="${baseClass}/imglist?{#bjui-selected}" data-toggle="dialog"  rel="BaseinfoClass_update" data-options="{id:'dialog',title:'查看图片',width:'600',height:'400'}" data-id="dialog-max" ><i class="fa fa-edit"></i><span>查看图片</span></a>&nbsp;&nbsp;</span>-->
	<span><a class="btn btn-red" href="${baseClass}/agentUpdate?{#bjui-selected}&agent_status=3" data-toggle="doajax"  data-confirm-msg = "确定要将该代理商上送审核么？" rel="BaseinfoClass_SendExamine" width="450" ><i class="fa fa-edit"></i><span>初步审核</span></a>&nbsp;&nbsp;</span>
    <span><a class="btn btn-red" href="${baseClass}/remark?{#bjui-selected}&agent_status=4" data-toggle="dialog" rel="BaseinfoClass_update" data-options="{id:'dialog',title:'代理商打回',width:'500',height:'240'}" id="cancelBtn"><i class="fa fa-edit"></i><span>代理商打回</span></a>&nbsp;&nbsp;</span>
   </div>
    ...
    <#list p.results as list>
	 <tr data-id="agent_num=${(list.AGENT_NUM)!}">
      ...
      <td style="color:red;">${(list.NOTE)!'<span style="color:gray">无</span>'}</td>
         ...
         <td>
             <span><a class="btn btn-blue" href="${baseClass}/adddetail?agent_num=${(list.AGENT_NUM)!}&ck=1&addtype=0" data-toggle="dialog"  rel="BaseinfoClass_update" data-options="{id:'dialog',title:'查看代理商',width:'920',height:'800'}"><i class="fa fa-edit"></i><span>查看详情</span></a>&nbsp;&nbsp;</span>
         </td>
     </tr>
	</#list>
   </#if>
