...
<div class="bjui-pageContent tableContent">
    <table class="table table-bordered table-hover table-striped table-top">
        ...
        <tr>
            ...
            <th width="12%">添加日期</th>
            <th width="12%">添加时间</th>
            <th width="12%">结算卡类型</th>
            <th width="12%">商户结算类型</th>
    ...
    <tr data-id="${(list.ID)!}" onclick="btnValide(${(list.SM_STATUS)!''})" >
        ...
        <td >
		    <#switch "${(list.CARDTYPE)!}">
		    	<#case "1"><span>对公</span><#break>
		    	<#case "2"><span>对私</span><#break>
		        <#default>
            </#switch>
        </td>
        <td >
		    <#switch "${(list.SETTTYPE)!}">
		    	<#case "0"><span>D0</span><#break>
		    	<#case "1"><span>T1</span><#break>
		        <#default>
            </#switch>
        </td>
        <td >
