...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${urls}" method="post">
        ...
        <div style="margin-top: 1px;height: 25pxheight: 25px">
            <span><a class="btn btn-blue permission" carte_id="${(carte_id)!'0'}" onclick="exportExcel(this); return false" width="450" rel="IncrementLog_exportExcel"><i class="fa fa-edit"></i><span>导出Excel</span></a>&nbsp;&nbsp;</span>
        </div>
